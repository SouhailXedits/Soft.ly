  ...
  return (
    <div className=" p-6 flex flex-col gap-6 h-screen">
      ...
      <div className=" bg-white rounded-lg p-3 flex lg:flex-col justify-around gap-3">
        <div className=" sm:flex-col flex items-center border-dashed border-2 border-gray-200 rounded-lg w-full justify-around">
          <img
        ...
        <div className=" sm:flex-col flex items-center border-dashed border-2 border-gray-200 rounded-lg w-full justify-around p-2">
          <img
            src="/qr_illustration.png"
            alt=" url illustration"
            className=" w-[60%] relative bottom-8"
          />
          <div className=" flex gap-4 items-center m-2">
